...
Pod::Spec.new do |s|
    ...
    s.homepage          = 'https://github.com/chbo297/pull-to-refresh'

    s.license           = { :type => 'MIT', :file => 'LICENSE' }
    s.authors           = { 'lihao' => 'lihao_ios@hotmail.com'}
    s.social_media_url  = 'https://github.com/chbo297'
    s.platform          = :ios, '8.0'
    s.source            = {:git => 'https://github.com/chbo297/pull-to-refresh.git', :tag => s.version}
